...
index: 1,
    ...
    addStyle: function (option) {
        ...
        let cssText = option.overwrite ? option.content : ".back-bg .pop-enclose{position: relative;width: 400px;top: 16%;height: 400px;left: 25%;}.back-bg>div.pop-enclose>.close-pop{cursor:pointer;border-radius: 20px; position: relative; top: 21px; z-index: 1001; left: 283px; background: #fff; width: 30px; height: 30px; line-height: 27px; text-align: center; }.back-bg .custom-option>input{width:100%}.big-bound-box{width:100%}.back-bg{position: fixed;width: 100%;top: 0;background: #2d2d2db8;z-index: 1000;left: 0;height: 100%;}.back-bg .custom-box {display: flex;justify-content: center;margin: auto;align-items: center;align-content: center}.back-bg .click-to-show {cursor: pointer;text-align: center;background: #509696;padding: 1rem}.back-bg .custom-option {padding: 1rem; border-radius: 5px; background: #ddd; position: absolute; z-index: 1000; overflow-y: scroll; overflow-x: hidden; max-height: 400px}.back-bg .option-box>div {padding: 0.7rem 0;border-bottom: 1px solid #bfbfbf;font-size: 14px;cursor: pointer}.back-bg .option-box>div:hover {border-bottom: 1px solid #8d8d8d}.back-bg input {padding: 1rem;border: none}.back-bg custom-option::-webkit-scrollbar-track{width:8px}.back-bg custom-option::-webkit-scrollbar-thumb{background: rgb(143, 128, 186);border-radius: 8px;}" + option.content
